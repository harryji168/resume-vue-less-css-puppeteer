...
2. Go to the cloned directory (e.g. `cd resume-vue-less-css-puppeteer`).

3. Run `npm install`. This may take a few seconds.

4. Customize your resume in the `resume/` directory: edit your data `data.yml` and replace the default profile-picture `harryji.png` with your picture. Rename your picture as `harryji.png` and copy it in the `resume/` directory. During this step, you may find it easier to navigate with Finder or File Explorer to get to the files. This will allow you to edit files with your computers default text editor. 
...
> GitHub [@harryji168](https://github.com/harryji168) &nbsp;&middot;&nbsp;

## License

[MIT](https://github.com/harryji168/resume-vue-less-css-puppeteer/blob/master/LICENCE.md)
